...
DB: trading_system_v29.db (or custom path when called from harness)

v29 changes vs v28
-------------------
One parameter change only -- all logic identical to v28.

1. recovery_hold_bars: 48 -> 72  (2d -> 3d)
   CyD diagnostic: RECOVERY@2025-04-09 -> CRASH@2025-04-13 (96h gap).
   v28's 48h hold expired at Apr-11, leaving a 48h window before the Apr-13
   CRASH re-entry. Raising to 72h bridges that gap.
   CyA diagnostic: RECOVERY@2022-07-24 -> CRASH@2022-07-26 (48h gap).
   Same fix applies: 72h hold carries through the Jul-26 spike.

   bull_hold_bars and rapid_descent_block_bars are UNCHANGED from v28.
"""
...
MACRO_DEFAULTS: Dict[str, Any] = {
    # --- existing params (unchanged from v28) ---
...
class MacroSupervisor:
    def __init__(self, db_path: Optional[str] = None, **kwargs):
        ...
        self.db_path = db_path or os.path.join(_dir, "trading_system_v29.db")
...
def main():
    ap = argparse.ArgumentParser(description="MacroSupervisor v29 standalone")
